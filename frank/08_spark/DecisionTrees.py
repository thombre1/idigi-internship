...
#Load CSV file and filter out the line with column name
...
# Make a model that uses the Decision Tree and its attribute
# categoricalFeatures, index 1 has 2 values, index 3 has 4 values.
...
# Collects the results from multiple computers wali RDD into a single list
